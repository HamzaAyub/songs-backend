...
<div id="content" class="container col-md-12">
	<?php 
		...
		if(isset($_POST['btnAdd'])){
			...
			if( !empty($video_title) && 
				...
				$sql_query = "INSERT INTO tbl_gallery (video_title, cat_id, video_duration, video_url, video_id,  video_description, video_type, viewdate)
						VALUES(?, ?, ?, ?, ?, ?, ?, ?)";
	...
	<div class="col-md-9">
		...
		<label>View Date :</label>		<br/>		<input type="text" class="controls input-append date form_datetime"  name="viewdate" id="viewdate" size="16"  value=""												data-date-format="yyyy-mm-dd hh:ii" >
		</div>
