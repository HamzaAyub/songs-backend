...
<div id="content" class="container col-md-12">
			...
			if( !empty($video_title) && 
				...
				!empty($video_description)){
					...
					$sql_query = "UPDATE tbl_gallery 
							...
							video_duration = ?, video_url = ?, video_id = ?, video_description = ? , viewdate = ?
							WHERE id = ?";
	...
	<div class="col-md-9">
		...
		<br/>				<label>View Date :</label>				<br/>		<input type="text" class="controls input-append date form_datetime"  name="viewdate" id="viewdate" size="16"  value="<?php echo $data['viewdate']; ?>"											data-date-format="yyyy-mm-dd hh:ii" >
		</div>
